...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-8 items-center justify-center rounded-full border-2 border-border bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AIDataFlowAnimation({ className }: { className?: string }) {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full max-w-sm flex-row items-stretch justify-between gap-6">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref} className="size-8">
            <Icons.user />
          </Circle>
        </div>
      </div>
