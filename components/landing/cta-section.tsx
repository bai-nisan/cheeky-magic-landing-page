...
const tiles = [
  ...
  },
  {
    ...
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 opacity-70 blur-[20px] filter"></div>
    ),
  },
  {
    icon: <BarChart className="size-full" />,
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-400 opacity-70 blur-[20px] filter"></div>
    ),
  },
];
          ...
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
            ...
            <div className="absolute z-10">
              <div className="mx-auto size-24 rounded-[2rem] border bg-background/10 p-3 shadow-2xl backdrop-blur-md dark:bg-background/10 lg:size-32">
                <Brain className="mx-auto size-16 text-foreground dark:text-foreground lg:size-24" />
              </div>
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                ...
                <p className="mt-2 max-w-sm">
                  Be first to experience the AI marketing revolution. Join our
                ...
                <div className="flex flex-col sm:flex-row gap-2 mt-4 w-full max-w-sm">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-[2rem] border border-border bg-background/50 backdrop-blur-sm text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                  <button
                    className={cn(
                      buttonVariants({
                      ...
                      "group rounded-[2rem] px-6 whitespace-nowrap"
                    )}
                  >
                    Join Waitlist
